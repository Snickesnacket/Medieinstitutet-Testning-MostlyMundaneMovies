...
describe('Mostly Mundane Movies', () => {
	...
	context('Home page', () => {
			...
			it.only('should contain an empty search field', () => {
				cy.get('.formMovieSearch').type('{enter}')
				.find('[type =submit]').click()
				cy.get('.fade').should('be.visible').contains("Aww, that's cute /n You tried to search, good for you! 👀")
			})
		})
